...
export function OAuthClientEditForm({
  ...
  const { field: grantTypesField } = useController({
    name: "update.grant_types",
    control,
  });

  const { field: responseTypesField } = useController({
    name: "update.response_types",
    control,
  });
    ...
    >
        ...
        <FieldSet>
          ...
          <FieldGroup className="grid sm:grid-cols-2 gap-4">
            <FormSelect
              ...
              name="update.token_endpoint_auth_method"
              label="Auth Method"
      ...
      <FieldGroup>
        <FieldSet>
          ...
          <FormInput
            control={control}
            name="update.software_statement"
      ...
      <FieldGroup>
        <FieldSet>
          ...
          <FieldGroup className="grid sm:grid-cols-2 gap-4">
            ...
            <FormSwitch
              control={form.control}
              name="update.enable_end_session"
              label="Enable Logout"
